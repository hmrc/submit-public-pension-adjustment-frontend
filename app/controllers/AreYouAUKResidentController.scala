...
class AreYouAUKResidentController @Inject() (
  ...
  formProvider: AreYouAUKResidentFormProvider,
  val controllerComponents: MessagesControllerComponents,
  view: AreYouAUKResidentView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] =
    (identify andThen getData andThen requireCalculationData andThen requireData) { implicit request =>
      val preparedForm = request.userAnswers.get(AreYouAUKResidentPage) match {
        case None        => form
