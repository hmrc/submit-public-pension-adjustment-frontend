...
class PensionSchemeMemberTaxReferenceControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new PensionSchemeMemberTaxReferenceFormProvider()
  ...
  "PensionSchemeMemberTaxReference Controller" - {
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        val boundForm = form.bind(Map("value" -> "123456789"))
