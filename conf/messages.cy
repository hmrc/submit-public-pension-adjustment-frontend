...
pensionSchemeDetails.error.pensionSchemeName.required = cy: Enter the name of the pension scheme that will pay the tax charge
pensionSchemeDetails.error.pensionSchemeTaxReference.required = cy: Enter the pension scheme tax reference of the scheme that will pay the tax charge
pensionSchemeDetails.error.pensionSchemeName.length = cy: The name of your pension scheme must be 100 characters or less
pensionSchemeDetails.error.pensionSchemeTaxReference.invalid = cy: Enter your pension tax reference in the format 00348916RT
...
whenDidYouAskPensionSchemeToPay.error.beforeMinimum = cy: You have entered a date you asked your pension scheme to pay before the remedy period, it must be after the beginning of the remedy period 6 April 2015
...
internationalAddress.postCode = cy: Postcode (optional)
...
internationalAddress.error.postCode.length = cy: Postcode must be 100 characters or less
...
internationalAddress.postCode.change.hidden = cy: Postcode
...
ukAddress.error.townOrCity.required = cy: Enter town or city
ukAddress.error.postCode.required = cy: Enter postcode
ukAddress.error.addressLine1.length = cy: Address line 1 must be 100 characters or less
ukAddress.error.addressLine2.length = cy: Address line 2 must be 100 characters or less
ukAddress.error.townOrCity.length = cy: Town or city must be 100 characters or less
ukAddress.error.county.length = cy: County must be 100 characters or less
ukAddress.error.postCode.length = cy: Postcode must be 8 characters or less
ukAddress.error.postCode.invalid = cy: Enter the postcode in the correct format
...
pensionSchemeMemberResidence.title = cy: Are they a UK resident?
pensionSchemeMemberResidence.heading = cy: Are they a UK resident?
pensionSchemeMemberResidence.checkYourAnswersLabel = cy: Are they a UK resident?
pensionSchemeMemberResidence.error.required = cy: Select yes if they are a UK resident
pensionSchemeMemberResidence.change.hidden = cy: Are they a UK resident?

pensionSchemeMemberUKAddress.title = cy: What is their address?
pensionSchemeMemberUKAddress.heading = cy: What is their address?
...
pensionSchemeMemberUKAddress.error.addressLine1.required = cy: Enter their address line 1
pensionSchemeMemberUKAddress.error.addressLine2.required = cy: Enter their address line 2 (optional)
...
pensionSchemeMemberUKAddress.error.addressLine1.length = cy: Address line 1 must be 100 characters or less
pensionSchemeMemberUKAddress.error.addressLine2.length = cy: Address line 2 must be 100 characters or less
pensionSchemeMemberUKAddress.error.townOrCity.length = cy: Town or city must be 100 characters or less
pensionSchemeMemberUKAddress.error.county.length = cy: County (optional) must be 100 characters or less
pensionSchemeMemberUKAddress.error.postCode.length = cy: Postcode must be 8 characters or less
pensionSchemeMemberUKAddress.error.postCode.invalid = cy: Enter their postcode in the correct format
...
pensionSchemeMemberInternationalAddress.postCode = cy: Postcode (optional)
...
pensionSchemeMemberInternationalAddress.error.postCode.required = cy: Enter their postcode (optional)
...
pensionSchemeMemberInternationalAddress.error.postCode.length = cy: Postcode must be 100 characters or less
...
memberDateOfDeath.error.required.two = cy:The member's date of death must include {0} and {1}
...
bankDetails.checkYourAnswersLabel = cy: Bank Details
