...
internationalAddress.addressLine1 = cy: addressLine1
internationalAddress.addressLine2 = cy: addressLine2
internationalAddress.townOrCity = cy: townOrCity
internationalAddress.stateOrRegion = cy: stateOrRegion
internationalAddress.postCode = cy: postCode
...
ukAddress.error.postCode.length = cy: Postcode must be 100 characters or less
